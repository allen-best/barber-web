  ...
  return (
    <footer id="contact" className="bg-secondary py-8 text-center text-textPrimary">
      <div className="container mx-auto px-4">
        ...
        <p className="mt-6 text-sm">&copy; {new Date().getFullYear()} Mazi Cutz. All rights reserved.</p>
      </div>
    </footer>
  );
}
